...
return (
    <Box background={'#e9e9e9'} pt={'50px'}>
    {data.map((ele)=>(   
        <Box background={'#e9e9e9'} w={'70%'} m={'auto'} key={ele.title}>
       <Box textAlign={'left'} p={3} fontFamily={'"Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif'}>
        <Box background={'white'} h={'auto'} p={3} boxShadow='rgba(0, 0, 0, 0.24) 0px 3px 8px'>
        <Text color={'#505458'} fontFamily={'gordita'} fontSize={'20px'}>Audit Results for -  {ele.WebsiteUrl}</Text>           
        <Score data={ele} url={url}/>
        </Box>
        <Box background={'white'} mt={4} borderRadius={5} p={5} boxShadow='rgba(0, 0, 0, 0.24) 0px 3px 8px'>
            <Box>
            ...
            <Box mt={5} background={'white'} p={5} pl={8} borderRadius={5} boxShadow='rgba(0, 0, 0, 0.24) 0px 3px 8px'>
